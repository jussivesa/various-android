package co.vesa.playaudiofromexternalstorage;
...
public class MainActivity extends Activity {
    ...
    private List<String> songs = new ArrayList<String>(); // Mediaplayer for playing music
    private MediaPlayer mediaPlayer = new MediaPlayer(); // use AsyncTask to load filenames
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // mp3 files recursively from sdcard (takes time to // make a list if a lot of songs in sdcard)
