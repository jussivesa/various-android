package co.vesa.googlemapswithmarker;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        */
        ...
        LatLng PAVILJONKI = new LatLng(62.239152, 25.757532);
        // create one marker
        final Marker ict = mMap.addMarker(new MarkerOptions()
                .position(ICT)
                .title("JAMK/ICT"));
        final Marker paviljonki = mMap.addMarker(new MarkerOptions()
                .position(PAVILJONKI)
                .title("PAVILJONKI"));
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(final Marker marker) {
                if (marker.equals(ict) || marker.equals(paviljonki)) {
