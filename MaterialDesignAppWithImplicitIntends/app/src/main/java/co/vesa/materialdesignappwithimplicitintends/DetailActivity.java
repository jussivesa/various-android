...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            // image
            ImageView courseImageView = (ImageView) findViewById(R.id.cardImageView);
            Glide.with(this).load("http://ptm.fi/jamk/android/golfcourses/"+jsonObject.getString("image")).into(courseImageView);
            // address
            TextView courseAddressTextView = (TextView) findViewById(R.id.cardAddressTextView);
            courseAddressTextView.setText(jsonObject.getString("address"));
            // phone
            TextView coursePhoneTextView = (TextView) findViewById(R.id.cardPhoneTextView);
            coursePhoneTextView.setText(jsonObject.getString("phone"));
            // email
            TextView courseEmailTextView = (TextView) findViewById(R.id.cardEmailTextView);
            courseEmailTextView.setText(jsonObject.getString("email"));
            // info
            TextView courseInfoTextView = (TextView) findViewById(R.id.cardInfoTextView);
            courseInfoTextView.setText(jsonObject.getString("text"));
            // web
            TextView courseWebTextView = (TextView) findViewById(R.id.cardWebTextView);
            courseWebTextView.setText(jsonObject.getString("web"));
            // map
            TextView courseMapTextView = (TextView) findViewById(R.id.cardMapTextView);
