...
/**
 * Remember to edit AndroidManifest.xml for DetailActivity
 * and also add decencies to gradle.build.
 * Also make sure to add permission for internet in AndroidManifest.xml.
 */
            ...
            public void onPostExecuteConcluded(JSONObject json) {
                if (json == null) {
                    ...
                    try {
                        ...
                        mAdapter = new MainAdapter(courses,getApplicationContext());
